...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _WALENTRY._serialized_end = 214
    _WALENTRY_OPTYPE._serialized_start = 139
    _WALENTRY_OPTYPE._serialized_end = 204
    _WAL._serialized_start = 216
    _WAL._serialized_end = 254
